...
<section class="h-screen w-full bg-base text-gray-50 flex flex-col items-end justify-between p-4">
	<div class="">
	...
	<div class="max-h-48 w-full font-semibold text-base md:text-2xl flex items-start space-x-4 relative">
		...
		<!-- <input type="text" placeholder="enter command" class="commandPrompt text-base text-7xl h-full p-2" style="caret-color: rebeccapurple; caret-shape: underscore;"> -->
	</div>
</section>